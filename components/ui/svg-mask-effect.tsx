...
export const MaskContainer = ({
  ...
  return (
    ...
    >
      <motion.div
        className="w-full h-full flex items-center justify-center text-4xl absolute bg-grid-white/[0.2] [mask-image:url(/mask.svg)] [mask-size:40px] [mask-repeat:no-repeat]"
        animate={{
